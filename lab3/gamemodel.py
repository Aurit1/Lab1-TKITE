...
class Game:
    ...
    def __init__(self, cannonSize, ballSize):
        ...
        self.windSpeed = random.random()*20.0 - 10.0
        self.players = [Player(self,False, -90, "blue"),Player(self,True, 90, "red")]
        self.round = 0 #Really just used as a player index, thought it be cool to track how many turns have passed

    """ A list containing both players """
    def getPlayers(self):
        return self.players #Done

    """ The height/width of the cannon """
    def getCannonSize(self):
        return self.cannonSize #Done

    """ The radius of cannon balls """
    def getBallSize(self):
        return self.ballSize  #Doone

    """ The current player, i.e. the player whose turn it is """
    def getCurrentPlayer(self):
        return self.players[self.round%2] # Done

    """ The opponent of the current player """
    def getOtherPlayer(self):
        return self.players[(self.round+1)%2] #Done
    
    """ The number (0 or 1) of the current player. This should be the position of the current player in getPlayers(). """
    def getCurrentPlayerNumber(self):
        return self.round%2 #Done
    ...
    def setCurrentWind(self, wind):
        self.windSpeed = wind #Done

    def getCurrentWind(self):
        return self.windSpeed #Done
...
class Player:
    ...
    def __init__(self, Game:Game,isReversed: bool, xPos, col):
    ...
    def fire(self, angle, velocity):
        ...
        if self.isReversed:
            _New_angle = 180 - self.aim[0]
        else: _New_angle = self.aim[0]
        self.projectile = Projectile(_New_angle, velocity, self.Game.getCurrentWind(), self.xPos, self.Game.getCannonSize()/2, -110, 110)
    ...
    def projectileDistance(self, proj):
        ...
        if ((self.getX() - (self.Game.getCannonSize()/2)) <= proj.getX() <= (self.getX()+(self.Game.getCannonSize()/2))):
            ...
            if self.getX() > proj.getX():
                return proj.getX() - self.getX() + self.Game.getCannonSize()/2 + self.Game.getBallSize()
...
class Projectile:
    ...
    def __init__(self, angle, velocity, wind, xPos, yPos, xLower, xUpper):
        ...
        self.xvel = velocity*cos(self.theta)
        self.yvel = velocity*sin(self.theta)
        self.wind = wind
